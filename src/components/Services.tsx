const Services = () => {
  ...
  return (
    <section id="our-core-services" className="bg-slate-900 py-20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#BBE1FA] mb-4">
            Our Core Services
          </h2>
          <p className="text-xl text-[#BBE1FAB2] max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-[#BBE1FA] mb-3">
                {service.title}
              </h3>
